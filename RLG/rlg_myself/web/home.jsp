    ...
    <div class="menu">
        <ul>
            <li>
                ...
                <dl>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/agent/agent_add.html',this)">用户列表</a></dt>
                </dl>
            </li>
            <li>
                ...
                <dl>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/goodsManage/goodsType_list.html',this)">商品列表</a></dt>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/goodsManage/goods_list.html',this)">商品更新</a></dt>
